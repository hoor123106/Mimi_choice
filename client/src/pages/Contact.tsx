...
export default function Contact() {
  ...
  function onSubmit(values: z.infer<typeof insertContactMessageSchema>) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Have a question about our products or your order? We're here to help. Reach out to the Mimi Choice team today.
          </p>
        </div>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/80 leading-relaxed">
                      123 Baby Lane,<br />Sweet Care District, 10001
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/80">+1 (555) 123-4567<br />Mon-Fri, 9am - 5pm EST</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/80">hello@mimichoice.com</p>
                  </div>
                </li>
              </ul>
            </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="John Doe" className="h-12 bg-slate-50 border-secondary focus-visible:ring-primary rounded-xl" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="+1 (555) 000-0000" className="h-12 bg-slate-50 border-secondary focus-visible:ring-primary rounded-xl" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="email" placeholder="john@example.com" className="h-12 bg-slate-50 border-secondary focus-visible:ring-primary rounded-xl" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          ...
                          className="min-h-[150px] bg-slate-50 border-secondary focus-visible:ring-primary rounded-xl resize-none" 
                          {...field} 
                        />
                      </FormControl>
                      <FormMessage />
                    ...
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md p-4 bg-secondary/30 border border-secondary">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel className="font-semibold cursor-pointer">
                          I am interested in buying products in bulk/wholesale.
                        </FormLabel>
                        <p className="text-sm text-muted-foreground">
                          Check this if you represent a retailer or pharmacy.
                        </p>
                      </div>
                    </FormItem>
                  )}
