...
export default function RegularFeeders() {
  const [searchQuery, setSearchQuery] = useState("");
  const { data: products, isLoading } = useProducts({ category: "Feeders", subcategory: "Regular Feeders" });
    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      <div className="bg-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold mb-4">Regular Feeders</h1>
          <p className="text-primary-foreground/80 max-w-2xl mx-auto">Classic slim-neck design, perfect for tiny hands to hold easily.</p>
        </div>
      </div>
