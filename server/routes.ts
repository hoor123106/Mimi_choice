...
async function seedDatabase() {
  ...
  await db.insert(products).values([
    ...
    {
      name: "Lion Character Regular 280ml",
      description: "Charming lion-character themed regular feeder (No: 1090). 280ml capacity with dual handles.",
      shortDescription: "Lion character regular feeder 280ml.",
      price: 2199,
    ...
    {
      name: "Blue Soft Regular 280ml",
      description: "Soft blue regular feeder with textured grip (No: 1091). 280ml capacity for easy holding.",
      shortDescription: "Blue soft regular feeder 280ml.",
      price: 2099,
